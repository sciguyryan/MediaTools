namespace MediaTools
{
    partial class PlaylistBuilderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { LastModified, FullPath, FileName, Duration, RawDuration });
            ...
            // export
            // 
            export.Location = new Point(223, 743);
            export.Name = "export";
            ...
            exportFormat.Items.AddRange(new object[] { "M3U" });
            ...
            statusStrip1.Location = new Point(0, 778);
